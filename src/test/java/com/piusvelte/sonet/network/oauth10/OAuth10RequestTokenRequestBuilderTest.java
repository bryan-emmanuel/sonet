...
/**
 * Created by bemmanuel on 6/23/15.
 */
@RunWith(PowerMockRunner.class)
@PrepareForTest({ TextUtils.class, Base64.class })
@PowerMockIgnore({ "javax.crypto.*" })
public class OAuth10RequestTokenRequestBuilderTest {

    private static final String CONSUMER_KEY = "ConsumerKey";
    private static final String CONSUMER_SECRET = "ConsumerSecret";

    private static final String REQUEST_URL = "https://test/request_token";
    private static final String CALLBACK_URL = "https://test/callback";
    ...
    public void setUp() throws Exception {
        ...
        // create Request
        mRequest = new OAuth10RequestTokenRequestBuilder(CONSUMER_KEY, CONSUMER_SECRET, CALLBACK_URL)
                .url(REQUEST_URL)
                .build();
    }
