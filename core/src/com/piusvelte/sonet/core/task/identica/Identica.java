...
public class Identica {

	private static final String TAG = "Identica";

	private SonetOAuth oauth;
	private HttpClient httpClient;

	public Identica(String token, String secret, HttpClient httpClient) {
		oauth = new SonetOAuth(IDENTICA_KEY, IDENTICA_SECRET, token, secret);
		this.httpClient = httpClient;
	}

	public boolean repeat(String statusId) {
