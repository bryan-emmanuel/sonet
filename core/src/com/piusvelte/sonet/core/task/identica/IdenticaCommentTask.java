...
public class IdenticaCommentTask extends CommentTask {

	private static final String TAG = "IdenticaCommentTask";

	public IdenticaCommentTask(SonetComments activity, long accountId) {
			...
			while (message.length() > 0) {
				...
				try {
					...
					if (SonetHttpClient.httpResponse(httpClient, sonetOAuth.getSignedRequest(httpPost)) != null)
						result = Sonet.getServiceName(activity.getResources(), Sonet.IDENTICA) + activity.getString(R.string.success);
					else
