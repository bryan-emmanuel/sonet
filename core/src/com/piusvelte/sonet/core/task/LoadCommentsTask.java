...
public class LoadCommentsTask extends AsyncTask<String, String, String> {
	...
	public LoadCommentsTask(SonetComments activity, long accountId) {
	...
	protected void onProgressUpdate(String... params) {
		activity.setDefaultMessage(params[MESSAGE]);
		activity.setLikeable(params[LIKE]);
	}
